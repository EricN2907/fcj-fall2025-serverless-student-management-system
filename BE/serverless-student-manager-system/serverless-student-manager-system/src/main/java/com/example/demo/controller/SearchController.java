...
import java.util.Collections; // <--- QUAN TRỌNG: Nhớ import cái này
...
public class SearchController {
    ...
    public ResponseEntity<?> search(
        ...
        // Gọi hàm convertJsonToMap (được viết ở bên dưới)
    ...
    private Map<String, Object> convertJsonToMap(String json) {
        if (json == null || json.trim().isEmpty()) {
            return Collections.emptyMap(); // Trả về map rỗng nếu ko có filter
        }
        try {
